...
:root {
  ...
  --font-weight-medium: 600; /* Semi Bold */
  ...
  --secondary-foreground: rgba(37, 37, 37, 1);
  ...
  --ring: rgba(28, 129, 239, 1);
  /* Shadow for small elevations, such as cards or modals. */
  --elevation-sm: 0px 4px 22px 0px rgba(0, 0, 0, 0.1);
  ...
  --chart-2: rgba(86, 136, 223, 1);
  /* The color for another chart element, such as a bar or line in a chart. */
  --chart-3: rgba(151, 219, 247, 1);
  /* The color for another chart element, such as a bar or line in a chart. */
  --chart-4: rgba(28, 129, 239, 1);
  /* The color for another chart element, such as a bar or line in a chart. */
  --chart-5: rgba(74, 234, 246, 1);
  ...
  --sidebar-ring: rgba(28, 129, 239, 1);
}
...
.dark {
  ...
  --input: rgba(0, 0, 0, 0);
  --input-background: rgba(30, 30, 30, 1);
  --ring: rgba(28, 129, 239, 1);
  --chart-1: rgba(37, 99, 235, 1);
  --chart-2: rgba(86, 136, 223, 1);
  --chart-3: rgba(151, 219, 247, 1);
  ...
  --sidebar-primary: rgba(60, 60, 60, 1);
  --sidebar-primary-foreground: rgba(255, 255, 255, 1);
  --sidebar-accent: rgba(28, 129, 239, 1);
  --sidebar-accent-foreground: rgba(255, 255, 255, 1);
  --sidebar-border: rgba(80, 80, 80, 1);
  --sidebar-ring: rgba(28, 129, 239, 1);
}
